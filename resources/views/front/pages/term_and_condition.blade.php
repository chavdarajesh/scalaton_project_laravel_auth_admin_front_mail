            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    <div class="col-lg-12 content order-last  order-lg-first">
                        ...
                        <p>Welcome to {{ env('APP_NAME', 'Laravel App') }}!</p>

                        <p>These terms and conditions outline the rules and regulations for the use of
                            {{ env('APP_NAME', 'Laravel App') }}'s Website, located at
                            {{ env('APP_URL', 'http://localhost') }}.</p>

                        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                            {{ env('APP_NAME', 'Laravel App') }} if you do not agree to take all of the terms and conditions
                        ...
                        <p>We employ the use of cookies. By accessing {{ env('APP_NAME', 'Laravel App') }}, you agreed to
                            use cookies in agreement with the {{ env('APP_NAME', 'Laravel App') }}'s Privacy Policy. </p>
                        ...
                        <p>Unless otherwise stated, {{ env('APP_NAME', 'Laravel App') }} and/or its licensors own the
                            intellectual property rights for all material on {{ env('APP_NAME', 'Laravel App') }}. All
                            intellectual property rights are reserved. You may access this from
                            {{ env('APP_NAME', 'Laravel App') }} for your own personal use subjected to restrictions set in
                        ...
                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                            information in certain areas of the website. {{ env('APP_NAME', 'Laravel App') }} does not
                            filter, edit, publish or review Comments prior to their presence on the website. Comments do not
                            reflect the views and opinions of {{ env('APP_NAME', 'Laravel App') }},its agents and/or
                            affiliates. Comments reflect the views and opinions of the person who post their views and
                            opinions. To the extent permitted by applicable laws, {{ env('APP_NAME', 'Laravel App') }}
                        ...
                        <p>{{ env('APP_NAME', 'Laravel App') }} reserves the right to monitor all Comments and to remove
                        ...
                        <p>You hereby grant {{ env('APP_NAME', 'Laravel App') }} a non-exclusive license to use, reproduce,
                        ...
                        <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                            ...
                            hyperlink compensates the absence of {{ env('APP_NAME', 'Laravel App') }}; and (d) the link is
                        ...
                        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                            our website, you must inform us by sending an e-mail to {{ env('APP_NAME', 'Laravel App') }}.
                            Please include your name, your organization name, contact information as well as the URL of your
                            site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on
                        ...
                        <p>No use of {{ env('APP_NAME', 'Laravel App') }}'s logo or other artwork will be allowed for

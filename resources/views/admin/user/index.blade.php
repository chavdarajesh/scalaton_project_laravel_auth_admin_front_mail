                                ...
                                @foreach ($Users as $User)
                                    <tr>
                                        ...
                                        <td class="text-center"><a
                                                href="{{ route('admin.get.user_referrals', $User->id) }}"><span
                                                    class="badge badge-center bg-success">{{ User::get_total_use_referral_user_by_id($User->id) }}</span></a>
                                        </td>
                                        ...
                                        <td class="text-center"> <input data-id="{{ $User->id }}" class="user_verified"
                                                type="checkbox" data-onstyle="success" data-offstyle="danger"
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button" class="btn btn-icon btn-outline-danger"
                                                ...
                                                data-bs-target="#user-delete-model-{{ $User->id }}">
